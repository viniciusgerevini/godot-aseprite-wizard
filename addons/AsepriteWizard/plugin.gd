...
const AnimatedSprite2DInspectorPlugin = preload("animated_sprite/inspector_plugin.gd")
...
func _load_config():
	...
	config.load_config()
	config.set_icon_arrow_down(editor_gui.get_theme_icon("GuiTreeArrowDown", "EditorIcons"))
	config.set_icon_arrow_right(editor_gui.get_theme_icon("GuiTreeArrowRight", "EditorIcons"))
...
func _setup_animated_sprite_inspector_plugin():
	animated_sprite_inspector_plugin = AnimatedSprite2DInspectorPlugin.new()
...
func _open_window():
	...
	window.connect("close_requested", _on_window_closed)
...
func _open_config_dialog():
	...
	config_window.connect("importer_state_changed", _on_importer_state_changed)
